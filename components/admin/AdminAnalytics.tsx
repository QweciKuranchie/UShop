    ...
    <div className="p-6 space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-dark-color flex items-center gap-3">
            <BarChart3 className="w-8 h-8 text-ushop-purple" />
            Business Analytics
          </h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <Button
            ...
            className="border-ushop-purple/20 hover:border-ushop-purple"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="border-ushop-purple/20">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <PieChart className="w-5 h-5 text-ushop-purple" />
        ...
        >
          <Card className="border-ushop-purple/20">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <TrendingUp className="w-5 h-5 text-ushop-purple" />
            ...
            <CardContent>
              <div className="space-y-3">
                {analytics?.topProducts?.slice(0, 5).map((product, index) => (
                  <div
                    key={index}
                    className="flex items-center justify-between p-3 bg-ushop_light_bg rounded-lg"
                  >
                    <div>
                    ...
                    <Badge className="bg-ushop-purple/20 text-ushop-purple-dark">
      ...
      >
        <Card className="border-ushop-purple/20">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <Activity className="w-5 h-5 text-ushop-purple" />
          ...
          <CardContent>
            <div className="space-y-3">
              {analytics?.recentActivity?.slice(0, 8).map((activity, index) => (
                <div
                  key={index}
                  className="flex items-center justify-between p-3 border border-ushop-purple/10 rounded-lg"
                >
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-ushop-purple rounded-full"></div>
