        ...
        <CardContent className="pt-6">
          <div className="flex items-start gap-4">
            ...
            <Avatar className="h-12 w-12">
              ...
              />
              <AvatarFallback className="bg-ushop-purple/10 text-ushop-purple-dark">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-start justify-between mb-3">
                <div>
                  <h4 className="font-semibold text-ushop-purple-dark">
                    {review.user?.firstName} {review.user?.lastName}
                  </h4>
                  <p className="text-sm text-gray-500">{review.user?.email}</p>
                  <Link
                    href={`/product/${review.product?.slug}`}
                    className="text-sm text-ushop-purple hover:underline"
                    target="_blank"
                  >
                    {review.product?.name}
                  </Link>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="text-2xl font-bold text-ushop-purple-dark">
                Review Management
              </CardTitle>
              <CardDescription>
