...
const AdminDashboardOverview = () => {
  ...
  const quickActions = [
    {
      ...
      icon: TrendingUp,
      href: "/admin/analytics",
      color: "from-ushop-purple to-ushop-purple-dark",
    },
    {
    ...
    },
    {
      ...
      icon: ShoppingCart,
      href: "/admin/orders",
      color: "from-ushop-pink to-purple-600",
    },
    {
      ...
      icon: Users,
      href: "/admin/users",
      color: "from-ushop-red to-orange-400",
    },
    {
      ...
      icon: Package,
      href: "/admin/products",
      color: "from-ushop_light_pink to-ushop-red",
    },
  ];
  ...
  return (
    <div className="p-6 space-y-8">
      ...
      <div className="text-center space-y-2">
        <div className="flex items-center justify-center gap-3">
          <h1 className="md:text-3xl font-bold text-dark-color flex items-center gap-3">
            <Activity className="w-8 h-8 text-ushop-purple" />
            Dashboard Overview
          </h1>
          <Button
            onClick={fetchStats}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {statCards.map((stat, index) => {
          ...
          return (
            ...
            >
              <Link href={stat.href}>
                <Card className="group hover:shadow-2xl transition-all duration-300 cursor-pointer border-ushop-purple/20 hover:border-ushop-purple/40 overflow-hidden">
                  ...
                  <Card className="group hover:shadow-2xl transition-all duration-300 cursor-pointer border-ushop-purple/20 hover:border-ushop-purple/40 overflow-hidden">
                    <CardContent className="p-6">
                      <div className="space-y-4">
                        ...
                        <div>
                          <h3 className="font-semibold text-dark-color group-hover:text-ushop-purple-dark transition-colors">
                            {action.title}
                          </h3>
                        ...
                        <Button
                          variant="ghost"
                          size="sm"
                          className="w-full justify-start p-0 h-auto text-ushop-purple hover:text-ushop-purple-dark"
                        >
                          Access →
                        </Button>
                      </div>
      ...
      <Card className="border-ushop-purple/20">
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <Calendar className="w-5 h-5 text-ushop-purple" />
            Recent Activity
          </CardTitle>
        </CardHeader>
        <CardContent>
