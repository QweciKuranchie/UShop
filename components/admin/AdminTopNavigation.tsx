  ...
  return (
    <>
      ...
      <div className="lg:hidden">
        <div className="flex items-center justify-between p-4 bg-white rounded-xl shadow-sm border border-ushop-purple/10">
      ...
      <div className="hidden lg:block">
        <div className="bg-white rounded-2xl shadow-xl border border-ushop-purple/10 overflow-hidden">
          {/* Admin Profile Header */}
          <div className="p-6 bg-gradient-to-r from-ushop-purple-dark to-ushop-purple text-white">
          ...
          <div className="px-6 py-4 border-b border-gray-100">
            ...
            >
              <div className="flex items-center space-x-2">
                <Menu className="h-5 w-5 text-ushop-purple-dark" />
                    ...
                    return (
                      <Link
                        ...
                        className={cn(
                          ...
                          isActive
                            ? "active bg-ushop-purple/10 border-ushop-purple shadow-md scale-[1.02]"
                            : "hover:bg-gray-50 border-gray-200 hover:border-ushop-purple/40"
                        )}
                        style={{
                      ...
                      >
                        <div
                          className={cn(
                            ...
                            isActive
                              ? "bg-ushop-purple text-white shadow-md"
                        ...
                        <div
                          className={cn(
                            ...
                            isActive ? "text-ushop-purple-dark" : "text-gray-900"
                          )}
                        >
      ...
      >
        <div
          className={cn(
            "admin-mobile-menu bg-white rounded-2xl shadow-xl border border-ushop-purple/10 overflow-hidden transform transition-all duration-300 ease-out",
            mobileMenuOpen
        ...
        >
          ...
          <div
            className={cn(
              "p-6 bg-gradient-to-r from-ushop-purple-dark to-ushop-purple text-white transition-all duration-200 delay-75",
              mobileMenuOpen
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    isActive
                      ? "active bg-gradient-to-r from-ushop-purple to-ushop-purple-dark text-white shadow-lg"
                      : "hover:bg-ushop_light_bg hover:shadow-md text-gray-900"
                  )}
                  style={{
                  ...
                  <div
                    className={cn(
                      ...
                      isActive
                        ...
                        : "bg-ushop-purple/10 text-ushop-purple group-hover:bg-ushop-purple/20"
                    )}
                  >
