...
const AdminHeader = ({ user }: AdminHeaderProps) => {
  ...
  return (
    <div className="bg-gradient-to-r from-white via-ushop_light_bg to-ushop_light_pink rounded-2xl shadow-lg border border-ushop-purple/10 p-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative hidden sm:block">
            ...
            <Input
              ...
              className="pl-10 w-64 border-ushop-purple/20 focus:border-ushop-purple"
            />
          </div>
          ...
          <Sheet open={isNotificationOpen} onOpenChange={setIsNotificationOpen}>
            <SheetTrigger asChild>
              <Button
                variant="outline"
                size="sm"
                className="relative border-ushop-purple/20 hover:border-ushop-purple hover:bg-ushop-purple/10"
              >
              ...
              <div className="p-4 space-y-4 max-h-[calc(100vh-100px)] overflow-y-auto">
                {notifications.length === 0 ? (
                  ...
                  notifications.map((notification) => (
                    <div
                      key={notification.id}
                      className="flex gap-3 p-4 bg-ushop_light_bg rounded-lg border border-ushop-purple/10 hover:bg-ushop-purple/5 transition-colors"
                    >
                      <div className="flex-shrink-0 w-2 h-2 bg-ushop-red rounded-full mt-2"></div>
          ...
          {/* User Avatar */}
          <div className="flex items-center gap-2 p-2 bg-white rounded-xl border border-ushop-purple/20">
            <div className="w-8 h-8 bg-gradient-to-br from-ushop-purple to-ushop-purple-dark rounded-lg flex items-center justify-center text-white font-semibold text-sm">
      ...
      {/* Quick Stats Bar */}
      <div className="mt-6 pt-4 border-t border-ushop-purple/20">
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
          <div className="text-center">
            <div className="text-lg font-bold text-ushop-purple-dark">
              {loading ? (
          ...
          <div className="text-center">
            <div className="text-lg font-bold text-ushop-red">
              {loading ? (
          ...
          <div className="text-center">
            <div className="text-lg font-bold text-ushop-pink">
              {loading ? (
          ...
          <div className="text-center">
            <div className="text-lg font-bold text-ushop-purple">98.5%</div>
