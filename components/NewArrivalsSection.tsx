  ...
  return (
    <Container className="mt-16 lg:mt-24">
      ...
      <div className="bg-gradient-to-br from-white via-ushop_light_bg to-ushop-pink/5 p-6 sm:p-8 lg:p-10 rounded-2xl shadow-xl border border-ushop-pink/10">
        ...
        <div
          ref={scrollRef}
          className="flex overflow-x-auto gap-4 sm:gap-6 pb-2 pt-1 snap-x snap-mandatory scrollbar-thin scrollbar-thumb-ushop-pink/30 scrollbar-track-transparent scroll-smooth"
        >
