...
const DealPage = async () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-red-50 to-orange-50">
      ...
      {/* Call to Action */}
      <Container className="py-8 sm:py-12">
        <Card className="bg-gradient-to-r from-ushop-purple to-ushop-pink text-white">
          <CardContent className="p-6 sm:p-8 lg:p-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Button
                size="lg"
                variant="outline"
                className="bg-transparent border-white text-white hover:bg-white hover:text-ushop-purple w-full sm:w-auto"
              >
                Subscribe for Deals
              </Button>
            </div>
